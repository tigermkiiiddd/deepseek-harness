...
| `ctx.team` | `seam` | [`team`](../packages/team/team) | - | [`tool-team`](../packages/team/tool-team), [`host-apiproxy`](../packages/host/apiproxy) | - | 持有持久化的成员花名册，启动成员进程，完成 ACP initialize 握手，并通过 Agent Client Protocol 驱动轮次。 |
