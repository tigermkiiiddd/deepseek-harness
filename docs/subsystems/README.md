...
| [team.md](team.md) | the team subsystem: ACP peer members as complete agents, `Config.members`, the member-connection contract, the `team` API domain, and the GUI global lane + per-agent interface design |
