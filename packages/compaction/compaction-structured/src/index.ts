 ...
 *
 * @module @deepseek-ai/dsh-compaction-structured
 */
...
export class StructuredCompactionEngine extends CompactionEngine {
  ...
  static Config: z<StructuredCompactionConfig> = z.object({
    thresholdRatio: thresholdRatioSchema,
    retainRatio: retainRatioSchema,
    retainTokens: retainTokensSchema,
    summarizationProvider: summarizationProviderSchema,
  ...
  constructor(ctx: Context, config: StructuredCompactionConfig = {}) {
    super(ctx)
  ...
  override async compactIfNeeded(
    ...
    // Pruning is optional so compaction-structured remains independently composable.
    ...
    if (context === undefined) {
      throw new TargetPressureConfigError(
        targetKey,
        `compaction-structured: no context capacity for ${targetKey}; `
...
export default StructuredCompactionEngine
