...
import * as CompactionBasicInvariant from '@deepseek-ai/dsh-compaction-structured/invariant'
...
import type {
  SummarizationInput,
  SummaryResult,
} from '@deepseek-ai/dsh-compaction-structured/src/summarizer.ts'
...
class GatedCompactionEngine extends StructuredCompactionEngine {
