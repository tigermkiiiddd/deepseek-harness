...
export const en = {
  ...
  modelApiUnset: 'Route default',
  refreshModels: 'Refresh models',
  refreshing: 'Syncing from the provider\u2026',
  refreshNeedsBaseUrl: 'Enter the base URL first, then refresh.',
  refreshEmpty: 'The provider listed no models. Add them by hand.',
  refreshedStatus: 'Synced {count} models \u00b7 {at}',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelApi: 'API 协议',
  modelApiUnset: '跟随路由默认',
  refreshModels: '刷新模型',
  refreshing: '正在从提供方同步…',
  refreshNeedsBaseUrl: '请先填写 API 地址，再刷新。',
  refreshEmpty: '该提供方没有列出任何模型，请手动添加。',
  refreshedStatus: '已同步 {count} 个模型 · {at}',
  customAdd: '添加自定义提供方',
  customTitle: '自定义提供方',
  customTag: '自定义',
  customRoute: 'Provider ID',
