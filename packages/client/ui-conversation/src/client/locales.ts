...
export const zh = {
  ...
  'user.rerun': '重发',
  'user.reedit': '编辑重发',
  'user.reedit.placeholder': '修改消息内容后重新发送',
  'user.reedit.send': '发送',
  'user.reedit.cancel': '取消',
...
export const en = {
  ...
  'hero.freeSession': 'Free session (no fixed directory)',
  ...
  'user.rerun': 'Re-run',
  'user.reedit': 'Re-edit',
  'user.reedit.placeholder': 'Edit the message before re-sending',
  'user.reedit.send': 'Send',
  'user.reedit.cancel': 'Cancel',
