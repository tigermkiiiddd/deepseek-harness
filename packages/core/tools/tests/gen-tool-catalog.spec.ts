...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'edit', 'enter_plan_mode', 'exit_plan_mode', 'followup_task', 'get_goal', 'glob', 'grep',
      'interrupt_agent', 'interrupt_agent', 'job_kill', 'job_list', 'job_output',
      'list_agents', 'list_agents', 'lsp', 'member_add', 'member_chat', 'member_model',
      'member_provider', 'member_remove', 'member_restart', 'member_sessions',
      'member_start', 'member_stop', 'pwsh', 'pwsh', 'ralph',
      'read', 'read_image', 'report', 'run_code', 'schedule_create', 'schedule_delete',
      'schedule_list', 'self_cognition', 'send_message', 'send_message', 'session_event_read', 'session_event_search',
      'session_event_trace', 'session_search', 'session_trace', 'set_cwd', 'skill', 'spawn_teammate',
      'str_replace_editor', 'subagent', 'team_task_create',
      'team_task_get', 'team_task_list', 'team_task_update', 'terminal_close', 'terminal_list',
      'terminal_open', 'terminal_read', 'terminal_send', 'terminal_signal', 'todo_read', 'todo_write',
