...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-team': { kind: 'none', reason: 'Browser-side team visualization and member-interface UI; registers nothing model-facing.' },
  ...
  'packages/bundle/acp-app': { kind: 'none', reason: 'The ACP member surface exposes the composed agent over the protocol; model, tools, and prompts belong to the base composition.' },
