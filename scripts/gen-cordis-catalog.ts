...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  MemberConfig: 'team.md',
  MemberConfigInput: 'team.md',
  MemberHistoryEntry: 'team.md',
  MemberSession: 'team.md',
  MemberSnapshot: 'team.md',
  MemberProviderConfigInput: 'team.md',
  MemberProviderInfo: 'team.md',
  MemberStatus: 'team.md',
  SessionConfigSnapshot: 'team.md',
  ...
  TeamPermissionRequest: 'team.md',
  ChatResult: 'team.md',
  TeamPermissionHandler: 'team.md',
  TeamPermissionOutcome: 'team.md',
  TranslatedSessionEvent: 'team.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  SessionUpdate: 'wire update type is owned by @agentclientprotocol/sdk (upstream protocol types)',
  StopReason: 'wire stop-reason union is owned by @agentclientprotocol/sdk (upstream protocol types)',
  ...
  ReseedAgentOptions: 'reseed options contract is owned by packages/core/agent/src/index.ts',
